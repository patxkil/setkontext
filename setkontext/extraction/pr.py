...
def extract_pr_decisions(
    ...
    Returns a Source, list of Decisions, and list of EntityRelationships.
    """
    source = Source(
        id=f"pr:{pr.number}",
        source_type="pr",
